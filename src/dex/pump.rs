...
impl Pump {
    ...
    pub async fn swap(
        ...
        let virtual_sol_reserves = u64::from(bonding_curve_account.virtual_sol_reserves);
        let virtual_token_reserves = u64::from(bonding_curve_account.virtual_token_reserves);
        ...
        let (token_amount, sol_amount_threshold, input_accouts) = match swap_direction {
            ...
            SwapDirection::Sell => {
                let sol_output = u64::from(amount_specified)
